...
export const execCommittee = [
	...
	{ name: 'Binidu Tishan', position: 'Vice President', image: BiniduTishan },
	{ name: 'Rashmitha Hansamal', position: 'Secretary', image: RashmithaHansamal },
	{ name: 'Pankaja Balasooriya', position: 'Treasurer', image: PankajaBalasooriya },
	{ name: 'Adeepa Kularathna', position: 'Web Master', image: AdeepaKularathna },
	{ name: 'Sasindu Hasanga', position: 'Assistant Secretary', image: SasinduHasanga },
];

export const subCommittees = [
	{
		name: 'Web & Marketing Committee',
		leads: [{ name: 'Ishan Sasanka', role: 'Lead', image: IshanSasanka }],
		members: [
			{ name: 'Buddhima Gayashan', image: BuddhimaGayashan },
			{ name: 'Sahan Harshajith', image: SahanHarshajith },
			{ name: 'Mishal Safeek', image: MishalSafeek },
			{ name: 'Thennakoon T.M.S.S.', image: Thennakoon },
			{ name: 'Akash Gandhawa', image: AkashGandhawa },
			{ name: 'Inuka Gunathilake', image: InukaGunathilake },
			{ name: 'Sadeep Herath', image: SadeepHerath },
			{ name: 'Chandupa Hulangamuwa', image: ChandupaHulangamuwa },
		],
	},
	{
		name: 'Design Committee',
		leads: [
			{ name: 'Chamod Wijesinghe', role: 'Co-Lead', image: ChamodWijesinghe },
			{ name: 'Imal Wickrama Arachchi', role: 'Co-Lead', image: ImalWickramaArachchi },
		],
		members: [
			{ name: 'Rajitha Lakshan', image: RajithaLakshan },
			{ name: 'Senuja Dilmith', image: SenujaDilmith },
			{ name: 'Akash Gandhawa', image: AkashGandhawa },
			{ name: 'Chamoth Liyanaarachchi', image: ChamothLiyanaarachchi },
			{ name: 'Akhila Nisal', image: AkhilaNisal },
		],
	},
	{
		name: 'Editorial Committee',
		leads: [{ name: 'Thanuja Mahalingam', role: 'Lead', image: ThanujaMahalingam }],
		members: [
			{ name: 'Minothma Sithumini', image: MinothmaSithumini },
			{ name: 'Sarjana Shanmugarajah', image: SarjanaShanmugarajah },
			{ name: 'Nimasha Amarathunga', image: NimashaAmarathunga },
			{ name: 'Ravichandran Sobatharsan', image: RavichandranSobatharsan },
		],
	},
	{
		name: 'Programme & Logistics Committee',
		leads: [
			{ name: 'Lithmin Karunarathna', role: 'Co-Lead', image: LithminKarunarathna },
			{ name: 'Chaniru Dewnitha', role: 'Co-Lead', image: ChaniruDewnitha },
		],
		members: [
			{ name: 'Helshi Saseka', image: HelshiSaseka },
			{ name: 'Kavindu Nethsara', image: KavinduNethsara },
			{ name: 'Sisuru Navod', image: SisuruNavod },
			{ name: 'Jaindu Devnaka', image: JainduDevnaka },
			{ name: 'Nipun Sankalana', image: NipunSankalana },
			{ name: 'K.B.L.S. Akalanka', image: LakminaSandesh },
			{ name: 'Shalini Madhuka', image: ShaliniMadhuka },
			{ name: 'Anusha Dananjaya', image: AnushaDananjaya },
			{ name: 'Kavindu Lakshan', image: KavinduLakshan },
		],
	},
	{
		name: 'Volunteer Management Committee',
		leads: [{ name: 'Laksandi Denipitiya', role: 'Lead', image: LaksandiDenipitiya }],
		members: [
			{ name: 'W.G.R Heshan', image: WGRHeshan },
			{ name: 'Chanuka Gimhan', image: ChanukaGimhan },
			{ name: 'Nimsika Bosilu', image: NimsikaBosilu },
			{ name: 'Chanupa Gurusinghe', image: ChanupaGurusinghe },
			{ name: 'Thiseni Rathnayake', image: ThiseniRathnayake },
		],
	},
	{
		name: 'Finance Committee',
		leads: [{ name: 'Suvindu Ranchigoda', role: 'Lead', image: SuvinduRanchigoda }],
		members: [
			{ name: 'Dulsika Mendis', image: DulsikaMendis },
			{ name: 'Sasindu Siyath', image: SasinduSiyath },
			{ name: 'Induwara Ranaweera', image: InduwaraRanaweera },
			{ name: 'Chalin Vanderslott', image: ChalinVanderslott },
			{ name: 'Thisangi Dewmini', image: ThisangiDewmini },
			{ name: 'Thiseni Abeykoon', image: ThiseniAbeykoon },
		],
	},
];
