...
export default function Footer() {
  return (
    <footer className="glass mt-12 mx-4 md:mx-8 mb-8 p-8 md:p-12 rounded-3xl border border-white/20 dark:border-white/10 relative overflow-hidden bg-white/60 dark:bg-zinc-900/60 backdrop-blur-xl shrink-0">
      <div className="absolute inset-0 bg-gradient-to-br from-primary-dark/5 to-primary-light/10 dark:from-primary-dark/10 dark:to-primary-light/5 opacity-50 pointer-events-none"></div>

      <div className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 text-center md:text-left">

        {/* Brand Section */}
        <div className="flex flex-col items-center md:items-start space-y-4">
          <Link to="/" className="flex items-center gap-2">
            <span className="text-2xl font-extrabold text-gray-900 dark:text-gray-50 tracking-tight font-heading">
        ...
        {/* Quick Links */}
        <div className="flex flex-col items-center md:items-start space-y-4">
          <h4 className="text-sm font-bold text-gray-900 dark:text-white uppercase tracking-widest relative inline-block">
            Quick Links
      ...
      <div className="max-w-7xl mx-auto mt-12 pt-8 border-t border-gray-200 dark:border-white/10 relative z-10 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex gap-4">
          <a href="https://www.facebook.com/rasieeeuom" target="_blank" rel="noreferrer" aria-label="Facebook" title="Facebook" className="w-10 h-10 rounded-full bg-gray-100 dark:bg-white/5 flex items-center justify-center text-gray-600 dark:text-gray-300 hover:bg-primary-dark hover:text-white dark:hover:bg-primary-light dark:hover:text-black transition-all shadow-sm hover:shadow-md hover:-translate-y-1">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" /></svg>
          </a>
          <a href="https://www.instagram.com/ieeesbuom/" target="_blank" rel="noreferrer" aria-label="Instagram" title="Instagram" className="w-10 h-10 rounded-full bg-gray-100 dark:bg-white/5 flex items-center justify-center text-gray-600 dark:text-gray-300 hover:bg-primary-dark hover:text-white dark:hover:bg-primary-light dark:hover:text-black transition-all shadow-sm hover:shadow-md hover:-translate-y-1">
          ...
          <a href="https://www.youtube.com/@ieee-ras" target="_blank" rel="noreferrer" aria-label="YouTube" title="YouTube" className="w-10 h-10 rounded-full bg-gray-100 dark:bg-white/5 flex items-center justify-center text-gray-600 dark:text-gray-300 hover:bg-primary-dark hover:text-white dark:hover:bg-primary-light dark:hover:text-black transition-all shadow-sm hover:shadow-md hover:-translate-y-1">
          ...
          <a href="https://www.linkedin.com/company/ieeeras-uom" target="_blank" rel="noreferrer" aria-label="LinkedIn" title="LinkedIn" className="w-10 h-10 rounded-full bg-gray-100 dark:bg-white/5 flex items-center justify-center text-gray-600 dark:text-gray-300 hover:bg-primary-dark hover:text-white dark:hover:bg-primary-light dark:hover:text-black transition-all shadow-sm hover:shadow-md hover:-translate-y-1">
